...
function displayCurrentLocation () {
    fetch('http://api.openweathermap.org/data/2.5/onecall?lat=' + currentLocationLat + '&lon=' + currentLocationLon + '&appid=3290fa4ab7af532d7cd9308947e66b17&units=imperial&exclude=minutely,hourly,alerts')
    .then(function (response) {
        return response.json();
    })
    .then(function (data) {
